...
// node_modules/.pnpm/@rive-app+canvas@2.37.1/node_modules/@rive-app/canvas/rive.js
var require_rive = __commonJS({
  "node_modules/.pnpm/@rive-app+canvas@2.37.1/node_modules/@rive-app/canvas/rive.js"(exports, module) {
          ...
          var __webpack_modules__ = [
              ...
              var Rive = (() => {
                ...
                return function(moduleArg = {}) {
                  ...
                  m.onRuntimeInitialized = function() {
                    ...
                    m.computeAlignment = function(f, g, k, p, n = 1) {
                  ...
                  var Da, Ea = false, z, B, Fa, Ia, C, F, Ja, Ka;
                  function La() {
                    var a = Da.buffer;
                  ...
                  var O = { O: null, V() {
                    ...
                    b && (c |= 146);
                    return c;
                  }, Ib = null, Jb = {}, Kb = [], Lb = 1, Mb = null, Nb = true, N = class {
                    constructor(a) {
                  ...
                  function jc(a, b, c) {
                    ...
                    if (b & 512 && !d) {
                      c = e;
                      c = "string" == typeof c ? Qb(c, { gb: true }).node : c;
                      if (!c.j.R) {
                        throw new N(63);
                      }
                    ...
                    b &= -131713;
                    e = Yb({ node: e, path: Sb(e), flags: b, seekable: true, position: 0, m: e.m, tc: [], error: false });
                    e.m.open && e.m.open(e);
                    !m.logReadFiles || b & 1 || (kc || (kc = {}), a in kc || (kc[a] = 1));
                    return e;
                  }
                  function lc(a, b, c) {
                    if (null === a.X) {
                  ...
                  sc.push(0, 1, void 0, 1, null, 1, true, 1, false, 1);
                  ...
                  var ee = { __syscall_fcntl64: function(a, b, c) {
                    ...
                    try {
                      ...
                      var f = Xb(a);
                      lc(f, b, d);
                      ab = [f.position >>> 0, ($a = f.position, 1 <= +Math.abs($a) ? 0 < $a ? +Math.floor($a / 4294967296) >>> 0 : ~~+Math.ceil(($a - +(~~$a >>> 0)) / 4294967296) >>> 0 : 0)];
                      C[e >> 2] = ab[0];
                      C[e + 4 >> 2] = ab[1];
                    ...
                    function a(c) {
                      ...
                      Qa--;
                      (_a3 = m.monitorRunDependencies) == null ? void 0 : _a3.call(m, Qa);
                      0 == Qa && (null !== Ra && (clearInterval(Ra), Ra = null), Sa && (c = Sa, Sa = null, c()));
                      return Z;
                    }
                    var b = { env: ee, wasi_snapshot_preview1: ee };
                    Qa++;
                    (_a2 = m.monitorRunDependencies) == null ? void 0 : _a2.call(m, Qa);
                    ...
                    Va || (Va = Ua("canvas_advanced.wasm") ? "canvas_advanced.wasm" : m.locateFile ? m.locateFile("canvas_advanced.wasm", ua) : ua + "canvas_advanced.wasm");
                    Za(b, function(c) {
                      a(c.instance);
                    }).catch(da);
                    return {};
                  ...
                  function ke() {
                    function a() {
                      if (!ie && (ie = true, m.calledRun = true, !Ea)) {
                        m.noFSInit || mc || (mc = true, m.stdin = m.stdin, m.stdout = m.stdout, m.stderr = m.stderr, m.stdin ? nc("stdin", m.stdin) : ic("/dev/tty", "/dev/stdin"), m.stdout ? nc("stdout", null, m.stdout) : ic("/dev/tty", "/dev/stdout"), m.stderr ? nc("stderr", null, m.stderr) : ic("/dev/tty1", "/dev/stderr"), jc("/dev/stdin", 0), jc("/dev/stdout", 1), jc("/dev/stderr", 1));
                        Nb = false;
                        fb(Na);
                        ca(m);
            ...
            (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
              ...
              __webpack_require__2.d(__webpack_exports__2, {
                ...
                RiveFont: () => (
                  /* reexport safe */
                  _riveFont__WEBPACK_IMPORTED_MODULE_3__.RiveFont
                ),
                /* harmony export */
                createFinalization: () => (
                  /* reexport safe */
              ...
              var _sanitizeUrl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__2(8);
              var _finalizationRegistry__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__2(9);
              var _riveFont__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__2(10);
            },
            /* 7 */
            /***/
            (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
